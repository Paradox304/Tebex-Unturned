...
using TebexUnturned.Shared.Components;
...
public class TebexUnturned : RocketPlugin<BaseTebexAdapter.TebexConfig>
{
    ...
    public static string GetPluginVersion() => "2.0.0-DEV";
    ...
    private void Init()
    {
        ...
        _webrequest = new(_adapter);
        _timers = new(_adapter);
        ...
        var chatListener = new UnturnedChatListener();
        chatListener.Register(this, _adapter);
    }

    public WebRequests WebRequests() => _webrequest;

    public PluginTimers PluginTimers() => _timers;

    public string GetGame() => "Unturned";
    ...
    private BaseTebexAdapter.TebexConfig GetDefaultConfig() => new();

    public static BaseTebexAdapter GetAdapter() => _adapter;
