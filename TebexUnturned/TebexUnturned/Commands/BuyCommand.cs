...
public class BuyCommand : IRocketCommand
{
    ...
    public List<string> Aliases => new() { "tebex.buy" };
    ...
    public void Execute(IRocketPlayer commandRunner, string[] args)
    {
        ...
        {
            _adapter.ReplyPlayer(commandRunner, "/tebex:buy cannot be executed via console. Use tebex:sendlink <username> <packageId> to specify a target player.");
            return;
        }
