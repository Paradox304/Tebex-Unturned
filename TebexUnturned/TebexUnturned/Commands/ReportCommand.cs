...
public class ReportCommand : IRocketCommand
{
    ...
    public List<string> Aliases => new() { "tebex.report" };
    ...
    public void Execute(IRocketPlayer commandRunner, string[] args)
    {
        ...
        if (args.Length == 2 && args[0] == "confirm")
        {
            ...
            _adapter.ReportManualTriageEvent(triageEvent, (code, body) => { _adapter.ReplyPlayer(commandRunner, "Your report has been sent. Thank you!"); }, (code, body) =>
            {
                _adapter.ReplyPlayer(commandRunner, "An error occurred while submitting your report. Please contact our support team directly.");
