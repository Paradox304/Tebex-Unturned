...
public class CheckoutCommand : IRocketCommand
{
    ...
    public List<string> Aliases => new() { "tebex.checkout" };
    ...
    public void Execute(IRocketPlayer commandRunner, string[] args)
    {
        ...
        {
            _adapter.ReplyPlayer(commandRunner, "/tebex:checkout cannot be executed via console. Use tebex:sendlink <username> <packageId> to specify a target player.");
            return;
        }
