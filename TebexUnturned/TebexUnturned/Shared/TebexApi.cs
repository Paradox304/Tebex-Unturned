...
namespace TebexUnturned.Shared;
...
public class TebexApi
{
    ...
    private static readonly Lazy<TebexApi> _apiInstance = new(() => new());
    ...
    private static void Send(
        string endpoint, string body, HttpVerb method = HttpVerb.GET, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null,
    ...
    public void GetAllSales(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public class TebexJoinEventInfo
    {
        ...
        [JsonProperty("event_date")] public DateTime EventDate { get; private set; }

        [JsonProperty("ip")] public string IpAddress { get; private set; }
    ...
    public void PlayerJoinEvent(List<TebexJoinEventInfo> events, ApiSuccessCallback onSuccess, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        Send("events", JsonConvert.SerializeObject(events), HttpVerb.POST, onSuccess, onApiError, onServerError);
    }
        ...
        public string GetFriendlyPayFrequency()
        {
            switch (Type)
            {
                case "single":
                    return "One-Time";
                case "subscription":
                    return $"Each {ExpiryLength} {ExpiryPeriod}";
                default:
                    return "???";
            }
        }
    ...
    public class Command
    {
        ...
        public long PackageRef { get; set; }

        [JsonProperty("conditions")] public CommandConditions Conditions { get; set; } = new();
     ...
     */
    public void GetCommandQueue(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    /**
         ...
         */
    public void GetOfflineCommands(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    /**
         ...
         */
    public void GetOnlineCommands(int playerId, ApiSuccessCallback onSuccess, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
     ...
     */
    public void DeleteCommands(int[] ids, ApiSuccessCallback onSuccess, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        var payload = new DeleteCommandsPayload { Ids = ids };
        Send("queue", JsonConvert.SerializeObject(payload), HttpVerb.DELETE, onSuccess, onApiError, onServerError);
    }
     ...
     */
    public void GetListing(ApiSuccessCallback onSuccess = null, ApiErrorCallback onError = null, ServerErrorCallback onServerError = null)
    {
     ...
     */
    public void GetAllPackages(bool verbose, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        Send(verbose ? "packages?verbose=true" : "packages", "", HttpVerb.GET, onSuccess, onApiError, onServerError);
    }

    /**
         * Gets a specific package from the webstore by its ID. Returns JSON-encoded Package object.
         */
    public void GetPackage(string packageId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    */
    ...
    public void GetCommunityGoals(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        Send("community_goals", "", HttpVerb.GET, onSuccess, onApiError, onServerError);
    }

    // Retrieves a specific community goal.
    public void GetCommunityGoal(int goalId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    /**
         ...
         */
    public void GetAllPayments(int limit = 100, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        var payload = new PaymentsPayload { Limit = limit };

        if (limit > 100)
            limit = 100;

        Send("payments", JsonConvert.SerializeObject(payload), HttpVerb.GET, onSuccess, onApiError, onServerError);
    }

    /**
         * Return all payments as a page, at the given page number.
         */
    public void GetAllPaymentsPaginated(int pageNumber, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    /**
         ...
         */
    public void GetPayment(string transactionId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    /**
         ...
         */
    public void CreateCheckoutUrl(int packageId, string username, ApiSuccessCallback success, ApiErrorCallback error = null)
    {
        var payload = new CreateCheckoutPayload { PackageId = packageId, Username = username };
    ...
    public void GetAllGiftCards(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        Send("gift-cards", "", HttpVerb.GET, onSuccess, onApiError, onServerError);
    }

    public void GetGiftCard(string giftCardId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public void CreateGiftCard(
        string expiresAt, string note, int amount, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        var payload = new CreateGiftCardPayload { ExpiresAt = expiresAt, Note = note, Amount = amount };
        Send("gift-cards", JsonConvert.SerializeObject(payload), HttpVerb.POST, onSuccess, onApiError, onServerError);
    }

    public void VoidGiftCard(string giftCardId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public void TopUpGiftCard(string giftCardId, double amount, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public void GetAllCoupons(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        Send("coupons", "", HttpVerb.GET, onSuccess, onApiError, onServerError);
    }

    public void GetCouponById(string couponId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public void GetAllBans(ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public void CreateBan(
        string reason, string ip, string userId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        var payload = new CreateBanPayload { Reason = reason, IP = ip, User = userId };
        Send("bans", JsonConvert.SerializeObject(payload), HttpVerb.POST, onSuccess, onApiError, onServerError);
    }
    ...
    public void GetUser(string targetUserId, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
    ...
    public class CustomerPackagePurchaseRecord
    {
        ...
        [JsonProperty("package")] public PackagePurchaseInfo Package { get; set; }
    }
    ...
    public void GetActivePackagesForCustomer(
        string userId, int? packageId = null, ApiSuccessCallback onSuccess = null, ApiErrorCallback onApiError = null, ServerErrorCallback onServerError = null)
    {
        if (packageId == null)
            Send($"player/{userId}/packages", "", HttpVerb.GET, onSuccess, onApiError, onServerError);
        else
        {
            Send($"player/{userId}/packages?package={packageId}", "", HttpVerb.GET, onSuccess, onApiError, onServerError);
        }
    }
